...
with flask_app.app_context():
    try:
        ...
        if missing_rel_fields:
            ...
            print(
                f"✓ OktaGroupRead has all relationship fields ({len(expected_relationship_fields)} relationship fields)"
            )
        ...
        if missing_role_fields:
            ...
            print("✓ RoleGroupRead has role-specific relationship fields")
        ...
        if missing_app_fields:
            ...
            print("✓ AppGroupRead has app-specific fields")
        ...
        print(
            f"✓ Group type discriminator working: OktaGroupRead type = {OktaGroupRead.model_fields['type'].annotation}"
        )
        print(
            f"✓ Group type discriminator working: RoleGroupRead type = {RoleGroupRead.model_fields['type'].annotation}"
        )
