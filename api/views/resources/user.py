        ...
        user = (
            ...
            .options(
                ...
                selectinload(OktaUser.active_group_memberships).options(
                    joinedload(
                        OktaUserGroupMember.active_group.of_type(ALL_GROUP_TYPES)
...
class UserList(MethodResource):
    ...
    def get(self) -> ResponseReturnValue:
        ...
        query = OktaUser.query.filter(OktaUser.deleted_at.is_(None)).order_by(
