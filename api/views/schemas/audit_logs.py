...
class AuditLogSchema(Schema):
    ...
    owners_should_expire_user_id_group_id = fields.List(fields.Nested(OktaUserGroupMemberSchema, only=("user_id", "group_id")))
    ...
    members_should_expire_user_id_group_id = fields.List(fields.Nested(OktaUserGroupMemberSchema, only=("user_id", "group_id")))
    ...
    owner_groups_should_expire_role_id_group_id = fields.List(fields.Nested(RoleGroupMapSchema, only=("role_group_id", "group_id"))),
    ...
    groups_should_expire_role_id_group_id = fields.List(fields.Nested(RoleGroupMapSchema, only=("role_group_id", "group_id"))),
