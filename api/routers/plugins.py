...
@router.get(
    "/app-group-lifecycle",
    name="app_group_lifecycle_plugins",
    response_model=AppGroupLifecyclePlugins,
)
...
@router.get(
    ...
    response_model=AppGroupLifecyclePluginAppConfig,
)
...
@router.get(
    ...
    response_model=AppGroupLifecyclePluginGroupConfig,
)
...
@router.get(
    ...
    response_model=AppGroupLifecyclePluginAppStatus,
)
...
@router.get(
    ...
    response_model=AppGroupLifecyclePluginGroupStatus,
)
