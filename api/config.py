...
# Optional env vars for OpenTelemetry
OTEL_EXPORTER_OTLP_HOST = os.getenv("OTEL_EXPORTER_OTLP_HOST")
OTEL_EXPORTER_OTLP_PORT = os.getenv("OTEL_EXPORTER_OTLP_PORT")
OTEL_EXPORTER_OTLP_PROTOCOL = os.getenv("OTEL_EXPORTER_OTLP_PROTOCOL")
OTEL_SERVICE_NAME = os.getenv("OTEL_SERVICE_NAME", "access")
OTEL_RESOURCE_ATTRIBUTES = os.getenv("OTEL_RESOURCE_ATTRIBUTES", "service.name=access")

if OTEL_EXPORTER_OTLP_HOST is not None and OTEL_EXPORTER_OTLP_PORT is not None:
    OTEL_EXPORTER_OTLP_ENDPOINT = f"http://{OTEL_EXPORTER_OTLP_HOST}:{OTEL_EXPORTER_OTLP_PORT}"
else:
