...
def test_ownership_sync(db: Any, mocker: MockerFixture) -> None:
...
def test_ownership_in_okta_not_in_db_authoritative(db: Any, mocker: MockerFixture) -> None:
    initial_okta_users = UserFactory.create_batch(3)
...
def test_ownership_in_okta_not_in_db_not_authoritative(db: Any, mocker: MockerFixture) -> None:
    initial_okta_users = UserFactory.create_batch(3)
    initial_okta_groups = GroupFactory.create_batch(3)
...
def test_ownership_in_db_not_in_okta_not_authoritative(db: Any, mocker: MockerFixture) -> None:
    initial_okta_users = UserFactory.create_batch(3)
    initial_okta_groups = GroupFactory.create_batch(3)
    _, _ = seed_db(db, initial_okta_users, initial_okta_groups)
...
def test_ownership_in_db_not_in_okta_authoritative(db: Any, mocker: MockerFixture) -> None:
    initial_okta_users = UserFactory.create_batch(3)
    initial_okta_groups = GroupFactory.create_batch(3)
    _, _ = seed_db(db, initial_okta_users, initial_okta_groups)
...
def test_app_ownership_in_db_not_in_okta_authoritative(db: Any, mocker: MockerFixture) -> None:
    initial_okta_users = UserFactory.create_batch(3)
...
def test_ownership_in_both_authoritative(db: Any, mocker: MockerFixture) -> None:
    initial_okta_users = UserFactory.create_batch(3)
    initial_okta_groups = GroupFactory.create_batch(3)
    _, _ = seed_db(db, initial_okta_users, initial_okta_groups)
...
def test_ownership_in_both_non_authoritative(db: Any, mocker: MockerFixture) -> None:
    initial_okta_users = UserFactory.create_batch(3)
    initial_okta_groups = GroupFactory.create_batch(3)
    _, _ = seed_db(db, initial_okta_users, initial_okta_groups)
...
def test_ownership_unamanaged_group_in_okta_not_in_db_authoritative(db: Any, mocker: MockerFixture) -> None:
    initial_okta_users = UserFactory.create_batch(3)
    initial_okta_groups = GroupFactory.create_batch(3)
    initial_db_users, initial_db_groups = seed_db(db, initial_okta_users, initial_okta_groups)
...
def test_ownership_through_multiple_groups_non_authoritative(db: Any, mocker: MockerFixture) -> None:
    initial_okta_users = UserFactory.create_batch(3)
    initial_okta_groups = GroupFactory.create_batch(3)
    _, _ = seed_db(db, initial_okta_users, initial_okta_groups)
...
def _get_group_owners(db: Any, group_id: str) -> dict[str, OwnershipDetails]:
    return {
...
def _get_group_ownership(db: Any, ownership_id: int) -> OwnershipDetails:
    ownership = (
        db.session.query(OktaUserGroupMember)
...
def _add_group_ownership_record(db: Any, user_id: str, group_id: str, ended_at: datetime) -> int:
