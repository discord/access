...
def test_retry_logic_error_response_retriable(mocker: MockerFixture, mock_sleep: Mock, okta_service: OktaService, status_code: int) -> None:
...
def test_retry_logic_error_response_non_retriable(mocker: MockerFixture, mock_sleep: Mock, okta_service: OktaService) -> None:
