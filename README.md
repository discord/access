...
| **UI Hiding Features**    |                                                                                                                                                                                                  |                                                                 |
| `HIDE_ROLE_REQUESTS`      | Hides the "Role Requests" navigation section and all related submenus                                                                                                                             | `true` or `false` (default: `false`)                           |
| `HIDE_EXPIRING_ROLES`     | Hides the "Expiring Roles" navigation section and all related submenus                                                                                                                            | `true` or `false` (default: `false`)                           |
| `HIDE_OWNERSHIP_SELECTION`| Hides Owner/Member toggle in Create Access Request forms (defaults to 'member' access)                                                                                                             | `true` or `false` (default: `false`)                           |
| `HIDE_GROUP_OWNER_BTNS`   | Hides group owner management buttons: "REQUEST OWNERSHIP", "ADD OWNERS", "ADD ROLES AS OWNERS"                                                                                                   | `true` or `false` (default: `false`)                           |
| `HIDE_GROUP_ROLE_MEMBER_BTNS` | Hides "ADD ROLES AS MEMBERS" button in group member sections                                                                                                                                 | `true` or `false` (default: `false`)                           |
| `HIDE_GROUP_EDIT_BTN`     | Hides the edit button (pencil icon) on group detail pages                                                                                                                                      | `true` or `false` (default: `false`)                           |
| `HIDE_ROLE_EDIT_BTN`      | Hides the edit button (pencil icon) on role detail pages                                                                                                                                       | `true` or `false` (default: `false`)                           |
| `HIDE_ROLE_OWNER_BTNS`    | Hides "ADD OWNER GROUPS" button on role detail pages                                                                                                                                           | `true` or `false` (default: `false`)                           |
| `HIDE_ROLE_GROUPS_ADD_BTNS` | Hides "ADD GROUPS" button on role detail pages                                                                                                                                               | `true` or `false` (default: `false`)                           |
