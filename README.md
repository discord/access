...
- `OTEL_EXPORTER_OTLP_HOST`: Specifies the OTLP endpoint hostname for your OpenTelemetry agent to collect traces and metrics. **[OPTIONAL] You can safely remove this from your env file**
- `OTEL_EXPORTER_OTLP_PORT`: Specifies the OTLP port for your OpenTelemetry agent.**[OPTIONAL] You can safely remove this from your env file**
