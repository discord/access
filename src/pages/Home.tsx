...
const guide: Record<string, Record<string, string>> = {
  ...
  admin: {
    [`About ${appName} administrators`]: `${appName} administrators are the users who are members of the App-Access-Owners group. Administrators are able create or edit all groups, roles, and apps and manage the access for any group in the system. Administrators can also create tags, set tag constraints, apply tags to groups or apps, and remove tags.`,
    'Creating an app':
