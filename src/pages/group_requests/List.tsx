...
export default function ListGroupRequests() {
  ...
  if (searchQuery != null && totalRows == 1) {
    navigate('/group-requests/' + rows[0].id, {
      replace: true,
    });
  }
  ...
  return (
    <>
      <ChangeTitle title="Group Requests" />
      <TableContainer component={Paper}>
        <TableTopBar title="Group Requests">
          <CreateGroupRequest currentUser={currentUser}></CreateGroupRequest>
        ...
        <Table sx={{minWidth: 650}} size="small" aria-label="groups">
          <TableHead>
            <TableRow>
              <TableCell>Requested Group</TableCell>
              ...
              <TableRow
                ...
                <TableCell>
                  {row.status != 'APPROVED' ? (
                    ...
                    <Link
                      to={`/groups/${row.requested_group_name}`}
                ...
                <TableCell>
                  <Button variant="contained" size="small" to={`/group-requests/${row.id}`} component={RouterLink}>
                    View
                  </Button>
                </TableCell>
              </TableRow>
