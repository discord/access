 ...
 *
 * Time limits are stored in seconds and shown in days. Everything else is a flag,
 * and only flags that are switched on reach this list, so the value is always yes.
 */
  ...
  return (
    <Box
      ...
      <ConstraintHelpRegion
        sections={[{paragraphs: constraintDetail(constraint, propagateToRoles)}]}
        expanded={help.expanded}
        regionId={help.regionId}
      />
    </Box>
