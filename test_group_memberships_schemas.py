...
with flask_app.app_context():
    try:
        ...
        member_read = GroupMemberRead(
            members=valid_user_ids,
            owners=[valid_user_ids[0]]
        )
        ...
        empty_update = GroupMemberUpdate(
            members_to_add=[],
            owners_to_add=[],
            members_to_remove=[],
            owners_to_remove=[]
        ...
        minimal_update = GroupMemberUpdate(
            members_to_add=[],
            owners_to_add=[],
            members_to_remove=[],
            owners_to_remove=[]
