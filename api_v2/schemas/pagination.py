...
from api_v2.schemas.users import UserSummary, UserGroupMember
...
class SearchAuditPagination(SearchPagination):
    ...
    order_by: AuditOrderBy = Field(
        default=AuditOrderBy.created_at,
...
# Forward reference models that aren't converted yet
...
# Import the real RoleGroupMap from groups module
try:
    from api_v2.schemas.groups import RoleGroupMap
except ImportError:
    # Fallback if circular import - will be resolved at runtime
