...
from api_v2.schemas.base import BaseCreateSchema, BaseReadSchema, BaseSchema
from api_v2.schemas.core_schemas import GroupRead, UserSummary
...
class AccessRequestBase(BaseSchema):
    ...
    status: AccessRequestStatus = Field(AccessRequestStatus.PENDING, description="Request status")
